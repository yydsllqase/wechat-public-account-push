export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx2d1c7ce4f5393a4d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8770fe07e8a9367fff5cd187d7ad55f2",
  ...
  USERS: [
    {
      ...
      id: "ozEnL55z5Cc1x0jclOqRUuukt2mk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "wvF8TeeNC3fvPiJdN4h4pcSTa0aS9ABy-HokHMkJez0",
      // 所在省份
      province: "湖南",
      // 所在城市
      city: "郴州",
  ...
  CALLBACK_TEMPLATE_ID: "wvF8TeeNC3fvPiJdN4h4pcSTa0aS9ABy-HokHMkJez0",
